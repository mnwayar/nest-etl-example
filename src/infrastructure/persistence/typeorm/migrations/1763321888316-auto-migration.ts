...
export class AutoMigration1763321888316 implements MigrationInterface {
    name = 'AutoMigration1763321888316'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."deals_source_status_enum" AS ENUM('ACTIVE', 'ARCHIVED')`);
        await queryRunner.query(`CREATE TABLE "deals" ("id" SERIAL NOT NULL, "source_id" character varying NOT NULL, "source_status" "public"."deals_source_status_enum" NOT NULL DEFAULT 'ACTIVE', "source_url" character varying(255), "source_created_at" TIMESTAMP WITH TIME ZONE, "source_updated_at" TIMESTAMP WITH TIME ZONE, "source_deleted_at" TIMESTAMP WITH TIME ZONE, "source_created_year" integer, "raw" jsonb, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying(255), "stage" character varying(255), "amount" character varying(255), "close_date" TIMESTAMP WITH TIME ZONE, CONSTRAINT "UQ_fb126796015483e0ba2bf4ca6be" UNIQUE ("source_id"), CONSTRAINT "PK_8c66f03b250f613ff8615940b4b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."contacts_source_status_enum" AS ENUM('ACTIVE', 'ARCHIVED')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."crm_sync_checkpoints_object_type_enum" AS ENUM('CONTACT', 'COMPANY', 'DEAL', 'ASSOCIATION')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."companies_source_status_enum" AS ENUM('ACTIVE', 'ARCHIVED')`);
        await queryRunner.query(`CREATE TABLE "companies" ("id" SERIAL NOT NULL, "source_id" character varying NOT NULL, "source_status" "public"."companies_source_status_enum" NOT NULL DEFAULT 'ACTIVE', "source_url" character varying(255), "source_created_at" TIMESTAMP WITH TIME ZONE, "source_updated_at" TIMESTAMP WITH TIME ZONE, "source_deleted_at" TIMESTAMP WITH TIME ZONE, "source_created_year" integer, "raw" jsonb, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying(255), "website_domain" character varying(255), "phone" character varying(50), "city" character varying(50), "country" character varying(50), "industry" character varying(255), CONSTRAINT "UQ_f2e423d7699c5fdaf8787ef6de7" UNIQUE ("source_id"), CONSTRAINT "PK_d4bc3e82a314fa9e29f652c2c22" PRIMARY KEY ("id"))`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP TABLE "companies"`);
        await queryRunner.query(`DROP TYPE "public"."companies_source_status_enum"`);
        await queryRunner.query(`DROP TABLE "crm_sync_checkpoints"`);
        await queryRunner.query(`DROP TYPE "public"."crm_sync_checkpoints_object_type_enum"`);
        await queryRunner.query(`DROP TABLE "contacts"`);
        await queryRunner.query(`DROP TYPE "public"."contacts_source_status_enum"`);
        await queryRunner.query(`DROP TABLE "deals"`);
        await queryRunner.query(`DROP TYPE "public"."deals_source_status_enum"`);
    }
